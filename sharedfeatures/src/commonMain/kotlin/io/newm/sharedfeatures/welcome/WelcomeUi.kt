    ...
    PreLoginArtistBackgroundContentTemplate(
        ...
        header = {
            Text(
                ...
                modifier = Modifier.align(Alignment.End).padding(16.dp).clickable(onClick = onCreateAccount),
            )
        },
    ) {
        Text(
        ...
        Column(
            ...
            PrimaryButton(text = stringResource(R.string.login_with_email), onClick = onLoginWithEmail)
            SecondaryButton(
