...
import newm_mobile.sharedfeatures.generated.resources.hide_password_description
import newm_mobile.sharedfeatures.generated.resources.show_password_description
...
fun TextFieldWithLabel(
    ...
    labelResId: StringResource? = null,
    labelStyle: TextStyle = formLabelStyle,
    value: String? = null,
    onValueChange: (String) -> Unit,
    isPassword: Boolean = false,
    enabled: Boolean = true,
    placeholderResId: StringResource? = null,
    ...
    Column(modifier) {
        ...
        labelResId?.let { Text(text = stringResource(it), style = labelStyle) }
        ...
        OutlinedTextField(
            ...
            placeholder =
                placeholderResId?.let {
                    { Text(text = stringResource(it), style = placeholderStyle) }
                },
            isError = isError,
            keyboardOptions = keyboardOptions,
