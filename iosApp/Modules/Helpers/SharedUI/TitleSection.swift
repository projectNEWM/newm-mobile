...
public struct TitleSectionModel {
    fileprivate let isGreeting: Bool
    fileprivate let title: String
    fileprivate let profilePic: URL?
    
    public init(isGreeting: Bool, title: String, profilePic: URL?) {
...
public struct TitleSection: View {
	private let model: TitleSectionModel
	
	public init(model: TitleSectionModel) {
		self.model = model
	}
	...
	private var profilePic: some View {
        guard model.profilePic == nil else { return EmptyView().erased }
        return AsyncImage(url: model.profilePic) { phase in
			switch phase {
