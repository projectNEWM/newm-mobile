...
internal class AndroidEventLoggerImpl(
    ...
    companion object {
        private const val MAX_EVENT_NAME_LENGTH = 32 // Firebase allows 40, but using 32 for readability
    ...
    override fun setUserProperty(
        ...
        logger.debug(tag = "analytics - user", message = "propertyName: $propertyName, value:$value")
