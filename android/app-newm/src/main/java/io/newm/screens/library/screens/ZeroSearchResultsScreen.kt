...
fun ZeroSearchResults() {
    Box(
        modifier =
            Modifier.fillMaxSize().padding(horizontal = 16.dp).testTag(TAG_NFT_LIBRARY_SCREEN),
        contentAlignment =
            Alignment.Center, // This centers the content both horizontally and vertically
    ) {
        Column(
