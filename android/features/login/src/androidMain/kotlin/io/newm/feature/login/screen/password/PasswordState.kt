...
class VerificationCodeState :
    TextFieldState(
        ...
        errorFor = { cxt, _ ->
            cxt.getString(R.string.code_verification_error_message, MINIMUM_VERIFICATION_CODE_LENGTH)
        },
    )
...
fun passwordValidationError(context: Context): String = context.getString(R.string.password_validation_error_message)

private fun passwordConfirmationError(context: Context): String = context.getString(R.string.password_confirmation_error_message)
