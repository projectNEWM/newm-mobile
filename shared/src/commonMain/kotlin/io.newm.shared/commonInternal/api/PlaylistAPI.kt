...
class PlaylistAPI(
    ...
    suspend fun getPlaylist(playlistId: String) =
        authClient
            .get("/v1/playlists/$playlistId") { contentType(ContentType.Application.Json) }
            .body<Playlist>()
    ...
    suspend fun deletePlaylist(playlistId: String) =
        authClient.delete("/v1/playlists/$playlistId") { contentType(ContentType.Application.Json) }
...
@Serializable data class NamePlayListRequest(
    val name: String,
)

@Serializable data class NamePlayListResponse(
    val playlistId: String,
)

@Serializable internal data class PlaylistCount(
    val count: Int,
)
