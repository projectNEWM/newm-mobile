...
/**
 * Interface representing a generic application logger. Provides methods for logging various levels
 * of messages and user information.
 */
interface AppLogger {
    /**
    ...
    /**
     * Logs a breadcrumb message. Breadcrumbs are used to leave a trail of events or actions that can
