 ...
 *
 * This class encapsulates information about a specific genre, including an optional identifier and
 * the genre's name. Both fields are nullable, allowing flexibility in cases where partial or
 * incomplete genre data might be encountered.
 *
