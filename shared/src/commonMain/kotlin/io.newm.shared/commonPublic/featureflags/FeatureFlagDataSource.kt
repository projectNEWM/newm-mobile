...
interface FeatureFlagDataSource {
    ...
    /** Flow that emits when any flag changes remotely. Emits the flag key that changed. */
    fun observeFlagChanges(): Flow<String>

    /**
     * Get the raw remote value from LaunchDarkly, bypassing cache and overrides. This is useful for
     * debugging to see what LaunchDarkly actually returns.
     */
